...
`NoRedZone` = 29L
`NoReturn` = 30L
`NoSanitizeCoverage` = 31L
`NoSync` = 32L
`NoUndef` = 33L
`NoUnwind` = 34L
`NonLazyBind` = 35L
`NonNull` = 36L
`NullPointerIsValid` = 37L
`OptForFuzzing` = 38L
`OptimizeForSize` = 39L
`OptimizeNone` = 40L
`ReadNone` = 41L
...
`SafeStack` = 46L
`SanitizeAddress` = 47L
`SanitizeHWAddress` = 48L
`SanitizeMemTag` = 49L
`SanitizeMemory` = 50L
`SanitizeThread` = 51L
`ShadowCallStack` = 52L
`Speculatable` = 53L
`SpeculativeLoadHardening` = 54L
`StackProtect` = 55L
`StackProtectReq` = 56L
`StackProtectStrong` = 57L
`StrictFP` = 58L
`SwiftAsync` = 59L
`SwiftError` = 60L
`SwiftSelf` = 61L
...
Builtin = 3L, Cold = 4L, Convergent = 5L, Hot = 6L, ImmArg = 7L, 
InReg = 8L, InaccessibleMemOnly = 9L, InaccessibleMemOrArgMemOnly = 10L, 
InlineHint = 11L, JumpTable = 12L, MinSize = 13L, MustProgress = 14L, 
Naked = 15L, Nest = 16L, NoAlias = 17L, NoBuiltin = 18L, NoCallback = 19L, 
NoCapture = 20L, NoCfCheck = 21L, NoDuplicate = 22L, NoFree = 23L, 
NoImplicitFloat = 24L, NoInline = 25L, NoMerge = 26L, NoProfile = 27L, 
NoRecurse = 28L, NoRedZone = 29L, NoReturn = 30L, NoSanitizeCoverage = 31L, 
NoSync = 32L, NoUndef = 33L, NoUnwind = 34L, NonLazyBind = 35L, 
NonNull = 36L, NullPointerIsValid = 37L, OptForFuzzing = 38L, 
OptimizeForSize = 39L, OptimizeNone = 40L, ReadNone = 41L, ReadOnly = 42L, 
Returned = 43L, ReturnsTwice = 44L, SExt = 45L, SafeStack = 46L, 
SanitizeAddress = 47L, SanitizeHWAddress = 48L, SanitizeMemTag = 49L, 
SanitizeMemory = 50L, SanitizeThread = 51L, ShadowCallStack = 52L, 
Speculatable = 53L, SpeculativeLoadHardening = 54L, StackProtect = 55L, 
StackProtectReq = 56L, StackProtectStrong = 57L, StrictFP = 58L, 
SwiftAsync = 59L, SwiftError = 60L, SwiftSelf = 61L, UWTable = 62L, 
WillReturn = 63L, WriteOnly = 64L, ZExt = 65L, LastEnumAttr = 65L, 
FirstTypeAttr = 66L, ByRef = 66L, ByVal = 67L, ElementType = 68L, 
InAlloca = 69L, Preallocated = 70L, StructRet = 71L, LastTypeAttr = 71L, 
FirstIntAttr = 72L, Alignment = 72L, AllocSize = 73L, Dereferenceable = 74L, 
DereferenceableOrNull = 75L, StackAlignment = 76L, VScaleRange = 77L, 
LastIntAttr = 77L, EndAttrKinds = 78L, EmptyKey = 79L, TombstoneKey = 80L
)
